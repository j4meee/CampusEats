        ...
        <div className="w-full max-w-md space-y-4 sm:space-y-5" onKeyDown={handleKeyDown}>
            ...
            <div className="space-y-4">
              ...
              {studentMode === "signin" ? (
                <p className="text-center text-xs sm:text-sm text-gray-400">
                  Use your registered CampusEats student account.
                </p>
              ) : (
                <p className="text-center text-xs sm:text-sm text-gray-400">
          ...
          {loginType === "staff" && (
            <>
              ...
              <button
                onClick={forgotMode ? handleForgotPassword : handleStaffLogin}
                disabled={loading}
              ...
              <p className="text-center text-xs sm:text-sm text-gray-400">
                {forgotMode
                  ? "Use your admin or vendor email to set a new password."
                  : "Admin and vendor accounts are managed by the school."}
              </p>
            </>
          )}

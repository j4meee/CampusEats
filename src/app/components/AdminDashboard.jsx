...
const vendors = [
  { id: 1, name: "Counter B Vendor", email: "vendor@campuseats.test", stall: "Counter B", status: "Active" },
  { id: 2, name: "Drink Stall", email: "drinks@campuseats.test", stall: "Drink Counter", status: "Pending" },
];

const orders = [
  { id: "A-042", student: "STU001", vendor: "Counter B", total: 8.30, status: "Preparing" },
  { id: "A-043", student: "CADT001", vendor: "Drink Counter", total: 1.50, status: "Ready" },
  { id: "A-044", student: "STU001", vendor: "Counter B", total: 5.00, status: "Pending" },
];
    ...
    <div className="min-h-screen bg-[#fafaf8]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-5 sm:py-7 space-y-5">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <SummaryTile icon={Store} label="Vendors" value="2" />
          <SummaryTile icon={ClipboardList} label="Orders Today" value="24" />
          <SummaryTile icon={BarChart3} label="Sales" value="$186.40" />
        </div>
